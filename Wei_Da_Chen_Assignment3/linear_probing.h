...
/*
This file contains the HashTableLinear class which implements linear probing, a
collision resolving technique, to access and modify the data in the HashTable.
*/
